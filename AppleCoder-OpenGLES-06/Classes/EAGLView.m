...
// const 
GLshort squareTextureCoords[96] = {
// Front face
0, 1,       // top left
0, 0,       // bottom left
1, 0,       // bottom right
...
- (id)initWithCoder:(NSCoder*)coder {
    ...
    if ((self = [super initWithCoder:coder])) {
		...
		// the following loop fill cubeVertices with values for the second cube
		int e=0;
		for (int f=0; f<72; f++) {
			if (++e == 3) {
				cubeVertices[72+f] = cubeVertices[f] - 1.0;
				e=0;
			} else {
				cubeVertices[72+f] = cubeVertices[f];
			}
		}
		
		// the following loop fill squareTextureCoords with values for the second cube
		// but I don't know if this is usefull
		for (int f=0; f<48; f++) {
			squareTextureCoords[48+f] = squareTextureCoords[f];
		}
...
//#define DEBUG
#ifdef DEBUG  
	NSLog(@"cubeVertices[72] (x): %f", cubeVertices[72]);  
	NSLog(@"cubeVertices[73] (y): %f", cubeVertices[73]);  
	NSLog(@"cubeVertices[74] (z): %f", cubeVertices[74]);  
	NSLog(@"cubeVertices[75] (x): %f", cubeVertices[75]);  
	NSLog(@"cubeVertices[76] (y): %f", cubeVertices[76]);  
	NSLog(@"cubeVertices[77] (z): %f", cubeVertices[77]);  
#undef DEBUG
#endif  
...
- (void)setupView {
    ...
    glClearColor(0.8f, 0.8f, 1.8f, 1.0f);
}
